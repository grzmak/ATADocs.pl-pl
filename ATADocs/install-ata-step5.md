...
2.  Kliknij bramę, którą chcesz skonfigurować, i podaj następujące informacje:
  ...
  > Zmiany konfiguracji są stosowane do bramy usługi ATA na następnej zaplanowanej synchronizacji między bramą usługi ATA a Centrum usługi ATA.
...
4. Włącz **Aktualizuj bramę usługi ATA automatycznie** , że w nadchodzących wersjach gdy użytkownik zaktualizuje Centrum usługi ATA, ta brama usługi ATA jest automatycznie aktualizowana.

5. Kliknij polecenie **Zapisz**.


## <a name="validate-installations"></a>Weryfikowanie instalacji
Aby sprawdzić, czy brama usługi ATA został wdrożony pomyślnie, sprawdź następujące kroki:
