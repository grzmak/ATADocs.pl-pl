...
3. Jeśli nie, nie komputera źródłowego (w obszarze **FROM** kolumny) systemu operacyjnego/aplikacji znane, aby zmodyfikować plik PAC? Jeśli tak, **Pomiń** podejrzanych działań (jest niegroźne pozytywną wartość true).
